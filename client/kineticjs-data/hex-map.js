...
var HexMap = Model({
  setMapData: function(hex, data) {
    this.hexData[hex.r][Math.floor(hex.r / 2) + hex.q] = data;
  },

  setTile: function(hex, tile) {
  ...
  getRange: function(hex, rStart, rEnd) {
    var results = [];
  ...
  getReachableTiles: function(hex, movement, passableFunc) {
    var me = this;
    var visited = {};
